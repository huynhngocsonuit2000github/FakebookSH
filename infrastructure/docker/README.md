...
- cd to root
  ...
  docker build -f infrastructure\docker\docker-files\Fakebook.Feed.Dockerfile -t fakebook-feed:v3 .
  docker build -f infrastructure\docker\docker-files\Fakebook.Bff.Dockerfile -t fakebook-bff:v7 .
